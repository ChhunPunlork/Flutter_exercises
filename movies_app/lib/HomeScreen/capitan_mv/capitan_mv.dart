...
class CapitanMv extends StatefulWidget {
  const CapitanMv({super.key});

  @override
  State<CapitanMv> createState() => _JusticeLeagueState();
}
var listTitiles = [
  "Episode",
  "Similar",
...
class _JusticeLeagueState extends State<CapitanMv> {
  @override
