...
class BraveMv extends StatefulWidget {
  const BraveMv({super.key});

  @override
  State<BraveMv> createState() => _JusticeLeagueState();
}
var listTitiles = [
  "Episode",
  "Similar",
...
class _JusticeLeagueState extends State<BraveMv> {
  @override
