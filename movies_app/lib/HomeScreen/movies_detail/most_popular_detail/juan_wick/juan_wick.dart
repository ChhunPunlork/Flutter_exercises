...
class JuanWick extends StatefulWidget {
  const JuanWick({super.key});

  @override
  State<JuanWick> createState() => _JusticeLeagueState();
}
var listTitiles = [
  "Episode",
  "Similar",
...
class _JusticeLeagueState extends State<JuanWick> {
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Stack(children: [
                Image.network(
                  "https://tse1.mm.bing.net/th?id=OIP.4u34MjHTKnSVtVenp3y_agHaEK&pid=Api&P=0&h=220",
