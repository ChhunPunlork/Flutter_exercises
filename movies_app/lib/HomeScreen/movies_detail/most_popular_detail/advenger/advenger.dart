...
class Advenger extends StatefulWidget {
  const Advenger({super.key});

  @override
  State<Advenger> createState() => _JusticeLeagueState();
}
var listTitiles = [
  "Episode",
  "Similar",
...
class _JusticeLeagueState extends State<Advenger> {
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Stack(children: [
                Image.network(
                  "https://1.bp.blogspot.com/-d4Dt-ysIlyI/T7lUjs5kdMI/AAAAAAAAAk8/2c3QXWQgVY4/s320/The-Avenger-Wallpaper.jpg",
