...
class JusticeLeague extends StatefulWidget {
  const JusticeLeague({super.key});

  @override
  State<JusticeLeague> createState() => _JusticeLeagueState();
}

var listTitiles = ["Episode", "Similar", "About"];
int currentindex = 0;

class _JusticeLeagueState extends State<JusticeLeague> {
  @override
        ...
        body: SingleChildScrollView(
          child: Column(
            children: [
              Stack(children: [
                Image.network(
                  "https://mir-s3-cdn-cf.behance.net/project_modules/disp/e5865358516595.59ffa0a2671f5.jpg",
                  ...
                  child: IconButton(
                    onPressed: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                            builder: (context) => CollectScreens()),
                      );
                    },
                    icon: Icon(
                  ...
                  children: <Widget>[
                    ElevatedButton(
                      ...
                      style: ButtonStyle(
                          ...
                          minimumSize:
                              WidgetStateProperty.all<Size>(Size(180, 50))),
                    ),
                    SizedBox(
                      width: 20,
                    ),
                    ElevatedButton(
                      ...
                      style: ButtonStyle(
                          backgroundColor:
                              WidgetStateProperty.all<Color>(Color(0xFF13102b)),
                          minimumSize:
                              WidgetStateProperty.all<Size>(Size(180, 50))),
                    )
                  ],
              ...
              Padding(
                ...
                child: Text(
                  "Not-official fanart designed by myself. Please, like and share. Hope you enjoy!",
                  style: GoogleFonts.afacad(
                    textStyle: TextStyle(
                      color: Colors.white38,
                      fontSize: 20,
                    ...
                    return Row(
                      children: [
                        TextButton(
                          ...
                          style: ButtonStyle(
                              minimumSize:
                                  WidgetStateProperty.all<Size>(Size(110, 30)),
