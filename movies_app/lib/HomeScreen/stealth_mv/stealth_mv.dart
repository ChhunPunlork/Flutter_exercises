...
class StealthMv extends StatefulWidget {
  const StealthMv({super.key});

  @override
  State<StealthMv> createState() => _JusticeLeagueState();
}
var listTitiles = [
  "Episode",
  "Similar",
...
class _JusticeLeagueState extends State<StealthMv> {
  @override
